...
mv delivery/fig_bars.txt ../snacks;
mv delivery/flourless_cake.txt ../dessert;
mv delivery/garlic.txt ../veggies;
mv delivery/goldfish.txt ../another_directory;
...
mv delivery/mint_milano_cookies.txt ../snacks;
mv delivery/onion.txt ../veggies;
mv delivery/oreos.txt ../snacks;
...
mv delivery/trail_mix.txt ../snacks;
...
mv delivery/wonder_bread.txt ../snacks;